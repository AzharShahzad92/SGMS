...
include_once 'inc/session.php';
	...
	?>
		  ...
		  <div class="alert alert-success" role="alert">
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<strong>Success!</strong> You are registered now!
		  </div>
	<?php
  ...
  <body class="text-center" data-new-gr-c-s-check-loaded="14.1012.0" data-gr-ext-installed="">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover my-auto">
        <h1 class="cover-heading">Welcome to FSRIF Online Portal Student Login</h1>
        <p class="lead">Please enter your Credentials.</p>
		<br>
			<form action="data/student_login.php" method="post">
